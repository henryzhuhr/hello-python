...
DEFAULT_FORMAT_STR = '[%(asctime)s]" " | %(levelname)s" " | %(pathname)s:%(lineno)d" " | %(message)s'
...
class CLogger:
    ...
    def add_stream_handler(self, level: int = logging.DEBUG, format_str=DEFAULT_FORMAT_STR):
        """初始化控制台处理器"""
